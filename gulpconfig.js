...
// Project paths
var project     = 'divi-child',                            // The directory name for your theme; change this at the very least!
    ...
    dist        = './wp/wp-content/themes/'+project+'/',   // The distribution package that you'll be uploading to your server; delete it anytime
...
module.exports = {
  ...
  browsersync: {
    ...
    proxy: 'http://div.test', // We need to use a proxy instead of the built-in server because WordPress has to do some server-side rendering for the theme to work
    watchOptions: {
  ...
  scripts: {
    ...
    namespace: 'divi-' // Script filenames will be prefaced with this (optional; leave blank if you have no need for it but be sure to change the corresponding value in `src/inc/assets.php` if you use it)
  },
